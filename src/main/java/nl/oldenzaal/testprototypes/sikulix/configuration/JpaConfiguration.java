package nl.oldenzaal.testprototypes.sikulix.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "nl.oldenzaal.testprototypes.sikulix.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "nl.oldenzaal.testprototypes.sikulix.model" });
